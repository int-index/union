...
>>> a ^? openUnion @Char
<interactive>:10:6: error: [GHC-39999]
...
-- inhabitants of the kind @u@; the type of values at any label @a :: u@
-- is given by its interpretation @f a :: Type@.
data Union (f :: u -> Type) (as :: List u) where
